...
// Prefer io_uring backend by default on Linux.
// Must be defined before any Asio headers are included.
...
// // Enable io_uring as the default backend on Linux when not otherwise configured.
// // These defines must appear before any Asio includes to select io_uring services.
// #if !defined(ASIO_HAS_IO_URING)
// #define ASIO_HAS_IO_URING 1
// #endif
// #if !defined(ASIO_HAS_IO_URING_AS_DEFAULT)
// #define ASIO_HAS_IO_URING_AS_DEFAULT 1
// #endif
// #if defined(__linux__) && !defined(ASIO_DISABLE_LIBURING)
// #  define ASIO_DISABLE_LIBURING 1
// #endif
